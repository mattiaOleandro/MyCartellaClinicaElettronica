...
public class MailNotificationService {
    ...
    public void sendActivationEmail(User user) {
        logger.debug(String.format("\'/sendActivationEmail\' method called at %s at line# %d .",
                MailNotificationService.class , lineGetter));
    ...
    public void sendPasswordResetMail(User user) {
        logger.debug(String.format("\'/sendPasswordResetMail\' method called at %s at line# %d .",
                MailNotificationService.class , lineGetter));
        SimpleMailMessage sms = new SimpleMailMessage();
